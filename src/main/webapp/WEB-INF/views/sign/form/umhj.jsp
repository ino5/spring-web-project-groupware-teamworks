...
<c:if test="${jspType == 'w' }">
	...
	<div id="content">
		...
		<div id="content_middle">
			<input type="hidden" name="sgf_id" value="umhj">
			<div id="div_content_wrap">
				<div id="div_content_container">
					<h1 class="sgf_name">업 무 협 조</h1>
					<%@include file = "/WEB-INF/views/sign/header/signContentContainerUpperPart.jsp" %>
										
					<div id="div_content">
						<table id="tb_content">
							<tr>
								<td class="td_head td_style_short">수신부서</td>
								<td class="td_style_long">
									<c:if test="${jspType == 'r'}">
										${mapOfSignContent.ssbs }
									</c:if>			
									<c:if test="${jspType == 'w'}">
										<input class="td_style_long" type="text" name="ssbs">
									</c:if>									
								</td>
							</tr>
							<tr>
